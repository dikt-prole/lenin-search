...
namespace LeninSearch.Ocr
{
    public partial class LabelingForm : Form
    {
        ...
        public LabelingForm()
        {
            ...
            save_btn.Click += Save_btnOnClick;
        ...
        private void OcrBlock_lbOnSelectedIndexChanged(object? sender, EventArgs e)
        {
            ...
            {
                g.DrawLine(Pens.Red, box.TopLeft.Point(), box.BottomLeft.Point());
                g.DrawLine(Pens.Red, box.BottomLeft.Point(), box.BottomRight.Point());
                g.DrawLine(Pens.Red, box.BottomRight.Point(), box.TopRight.Point());
                g.DrawLine(Pens.Red, box.TopRight.Point(), box.TopLeft.Point());
        ...
        private void Save_btnOnClick(object? sender, EventArgs e)
        {
